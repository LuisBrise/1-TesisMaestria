...
\sincapitulo{Introducción}{1-Introduccion.tex}
\capitulo{Teoría y métodos}{2-Teoria-y-metodos.tex}{Teor\'ia y métodos}
\capitulo{Resultados y discusión}{3-ResultadosyDiscusion.tex}{Resultados y discusión}
...
\end{toexclude}
%
\capitulo{Conclusiones y trabajo a futuro}{4-Conclusionesyperspectivas.tex}{Conclusiones y trabajo a futuro}
%%-------------------------------------------------------------------------------------
%%-------------------------------------------------------------------------------------
%--------------------------------- START EXCLUIMOS--------------------------------------
\begin{toexclude}
...
\apendice{Apéndice A\\ Método de los potenciales escalares}{Apendice-A-ScalarPotentials.tex}
%
%------------------------------------------------------------------------------------
%
%------------------------------------------------------------------------------------
...
\apendice{Apéndice B\\  Transferencia de momento angular debida al campo externo}{Apendice-B-TMA_ext.tex} 
%
%------------------------------------------------------------------------------------
%
%%-------------------------------------------------------------------------------------
